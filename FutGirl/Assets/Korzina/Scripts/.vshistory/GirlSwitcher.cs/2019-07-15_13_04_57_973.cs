...
namespace Assets.Korzina.Scripts
{
    public class GirlSwitcher : MonoBehaviour
    {
        ...
        public static void OnIndexChange(int index)
        {
            ...
            if(tier_obj.tier>player_manager.max_tier || (tier_obj.tier==player_manager.current_tier && (tier_obj.girl > player_manager.max_girl || tier_obj.pos > player_manager.max_pos)))
        }
    }
}
