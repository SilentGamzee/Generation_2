...
namespace Assets.Korzina.Scripts
{
    public class ShopManager : MonoBehaviour
    {
        ...
        private static Button current_upgrade { get => current_upgrade1;
            set {
        ...
        void Start()
        {
            ...
            for (var i = 0; i < PlayerManager._instance.Tiers_count - 1; i++)
            {
            ...
            SaveInfo.upgrades.ForEach(x =>
            {
                foreach (var kv in upgradeDict)
                {
                    ...
                    if (x == v)
                    {
                        ...
                        current_upgrade = k;
                        LevelController._instance.SetImageIndex();
                    }
                }
            });
        }
        ...
        void OnUpgrade(Button b)
        {
            ...
            if (manager.goals < upgradeDict[b] || SaveInfo.upgrades.Contains(upgradeDict[b])) return;
