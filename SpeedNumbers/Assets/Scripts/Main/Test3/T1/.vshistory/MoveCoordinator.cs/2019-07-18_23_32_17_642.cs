...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        public static void Init()
        {
            ...
            var my = ButtonListener._instance.myBalls;
            var enemy = ButtonListener._instance.enemyBalls;
            var game_ball = ButtonListener._instance.ball;
            my.AddRange(enemy);
            my.Add(game_ball);
            my.ForEach(x => start_pos_dict.Add(x, x.transform.position));
        }
        ...
        public static void AddForceToBall(GameObject ball) => AddForce(ball, 0.05f, 0, 0);

        public static void AddForceToBallBottom(GameObject ball) => AddForce(ball, -0.05f, 0, 0);
        ...
        void DoArtificalMove()
        {
            ...
            var unit = enemy[r];
            Vector3 diff = Camera.main.ScreenToWorldPoint(Input.mousePosition) - unit.transform.position;
            diff.Normalize();
        }
