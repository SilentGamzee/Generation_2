...
public class GameEndManager : MonoBehaviour
{
    ...
    {
        _instance.wave_counter.text = BulletObject.kill_count + "/" + HardModeButton.static_wave_count;
        _instance.progress_bar.fillAmount = BulletObject.kill_count / (float)HardModeButton.static_wave_count;
    }
