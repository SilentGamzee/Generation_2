    ...
    public class BuildingObject : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (time <= 0)
            {
                ...
                under_panel.gameObject.SetActive(false);
                is_training = false;
                training_t = 0;
            ...
            under_text.gameObject.SetActive(true);
            under_text.text = "Time left:\n" + time;
