...
namespace Assets.Scripts.Main.Test6
{
    public class ShopUpgradeObject : MonoBehaviour
    {
        ...
        const string speed_title = "Increase total time +1 sec";
        const string switch_title = "Increase click time +1 sec";
        const string training_title = "Increase reward +10 gold";
