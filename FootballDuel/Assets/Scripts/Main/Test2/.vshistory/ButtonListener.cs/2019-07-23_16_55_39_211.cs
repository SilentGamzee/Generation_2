    ...
    class ButtonListener : MonoBehaviour
    {
        ...
        public static int Lives
        {
            ...
            set
            {
                ...
                _instance.myHp_progress.fillAmount = value / Lives_max;
                if (value <= 0)
                {
        ...
        public static int LivesEnemy
        {
            ...
            {
                lives = value;
                _instance.enemyHp_text.text = value + "/" + Lives_max;
                _instance.enemyHp_progress.fillAmount = value / Lives_max * 100f;
                if (value <= 0)
                {
