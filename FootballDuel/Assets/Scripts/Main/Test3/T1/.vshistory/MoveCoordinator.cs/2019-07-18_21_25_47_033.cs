...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        public static void AddForceToBallLight(GameObject ball) => AddForce(0.01f, 0, 0);

        public static void AddForceToBallLeft(GameObject ball) => AddForce(ball, 0.02f, 0, 0.03f);
