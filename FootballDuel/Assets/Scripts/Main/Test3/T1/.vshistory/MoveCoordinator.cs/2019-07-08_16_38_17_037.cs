...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        private static void AddForce(Vector2 up, Vector2 right, Vector2 left)
        {
        ...
        public static void AddForceToBall()
        {
            ...
            */
            ...
            AddForce(item.up * 0.05f, item.right * 0.02f, Vector2.zero);
        }
        ...
        public static void AddForceToBallLight()
        {
            ...
            */
            ...
            AddForce(item.up * 0.01f, Vector2.zero, Vector2.zero);
        }
