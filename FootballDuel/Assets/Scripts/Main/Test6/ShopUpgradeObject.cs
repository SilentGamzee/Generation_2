...
namespace Assets.Scripts.Main.Test6
{
    public class ShopUpgradeObject : MonoBehaviour
    {
        ...
        const string switch_title = "Upgrade balls speed ";
        const string training_title = "Upgrade balls damage ";
        ...
        void Start()
        {
            total_cost = cost + cost * require_lvl * cost_mult;
        ...
        public void OnUpgrade(bool safe)
        {
            ...
            total_cost = cost + cost * require_lvl * cost_mult;
            Debug.Log(cost + " " + require_lvl + " " + cost_mult);
            transform.GetChild(0).GetComponent<Text>().text = "cost: " + total_cost;
            switch (upgrade_id)
            {
                case 0: PlayerManager.player_speed_lvl++; break;
                case 1: PlayerManager.player_ball_speed_lvl++; break;
                case 2: PlayerManager.player_ball_damage_lvl++; break;
            }
