...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        private static Dictionary<GameObject, float> objPoints = new Dictionary<GameObject,float>();
        ...
        public static void Init()
        {
            ...
            for (var i = 0; i < trans.childCount; i++)
            {
                ...
                x_points.Add(x_pos);
                objPoints.Add(item.gameObject, x_pos);
            }
        ...
        void Update()
        {
            ...
            for (var i = 0; i < trans.childCount; i++)
            {
                ...
                if (Math.Abs(r_pos.x - move_x)<=0.001f)
                {
