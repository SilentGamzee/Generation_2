...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        public static void Init()
        {
            ...
            {
                var y_pos = row.transform.position.x;
                y_points.Add(y_pos);
            }
        ...
        void Update()
        {
            ...
            InitScript._instance.randomRow.transform.position = Vector3.MoveTowards(r_pos, new Vector3(y_points[x], r_pos.y, r_pos.z), step);

            if (InitScript._instance.randomRow.transform.position.x == y_points[x])
            {
                AddForeground(x);
                ResetRandomRow();
