...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        public static void AddForceToBallLeft(GameObject ball) => AddForce(ball, 0.00f, 0, 0.03f);

        public static void AddForceToBallRight(GameObject ball) => AddForce(ball, 0.00f, 0.03f, 0);
