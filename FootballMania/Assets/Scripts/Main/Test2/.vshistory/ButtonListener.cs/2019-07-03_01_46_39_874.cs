...
namespace Assets.Scripts.Main
{
    class ButtonListener : MonoBehaviour
    {
        ...
        private static float avgHeightTotalValue;
        private static float avgHeightValue { get => avgHeightValue1; set
            {
                avgHeightValue1 = value;
                _instance.avgHeight.text = "Avg height: " + value.ToString("F2");
            }
        }
