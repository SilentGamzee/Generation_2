...
namespace Assets.Scripts.Main
{
    class MoveCoordinator : MonoBehaviour
    {
        ...
        public static void Init()
        {
            ...
            start_y = InitScript._instance.randomRow.transform.position.y;
        ...
        private static void ResetRandomRow()
        {
            ...
            random_trans.position = new Vector3(random_trans.position.x, start_y, random_trans.position.z);
        }
        ...
        void Update()
        {
            ...
            InitScript._instance.randomRow.transform.position = Vector3.MoveTowards(r_pos, new Vector3(r_pos.x, y_points[y], r_pos.z), step);

            Debug.Log(InitScript._instance.randomRow.transform.position.y+" "+ y_points[y]+" "+(InitScript._instance.randomRow.transform.position.y == y_points[y]));
            if ((InitScript._instance.randomRow.transform.position.y - y_points[y])<0.001f)
            {
                AddForeground(y);
                ResetRandomRow();
